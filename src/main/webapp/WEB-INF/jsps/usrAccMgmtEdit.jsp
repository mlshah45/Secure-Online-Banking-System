...
<body>
   ...
   <div class="btn-group btn-group-justified">
	...
	<a href="/Sparkys-Bank/UserAccountManagementActivity" class="btn btn-primary">Activity</a>
      ...
      <form:form class="form-horizontal" commandName="accessInfo" method="post" action="/Sparkys-Bank/UserAccountManagementEdit">
    <fieldset>
   ...
   <div>
   <h4>Please note that only the Address and Email information is editable</h4>
	<form:form commandName="accessInfo" action="/Sparkys-Bank/UserAccountManagementEdit" method="post">
