...
<body>
   <jsp:include page="internalHome.jsp"></jsp:include>
    <form:form class="form-horizontal" commandName="accessInfo" method="post" action="/Sparkys-Bank/EditEmpProfile">
    <fieldset>
   ...
   <h4>Please note that only the Address information is editable</h4>
	<form:form commandName="accessInfo" action="/Sparkys-Bank/EditEmpProfile" method="post">
